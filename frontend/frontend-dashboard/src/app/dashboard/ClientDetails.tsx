  ...
  return (
    ...
    >
      ...
      <DialogContent dividers>
        {/* Import Roboto pour cette modale uniquement */}
        <link href="https://fonts.googleapis.com/css?family=Roboto:400,500,700&display=swap" rel="stylesheet" />
        <style>{`
          .client-details-modal-roboto * {
            font-family: 'Roboto', Arial, sans-serif !important;
          }
        `}</style>
        <div className="client-details-modal-roboto" style={{ display: 'flex', gap: 16, minHeight: 300, maxHeight: '100vh', overflow: 'auto', fontSize: '0.93rem' }}>
